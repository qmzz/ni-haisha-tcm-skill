...
- **来源线索：** `source_fts` 未以“土鳖虫”直接命中；相关异名“地鳖虫/蛰虫”存在语料命中，但尚未由 registry 绑定到本条目，不作为安全字段来源。
- **毒性/强作用概况：** 当前已治理 registry 未提供本条目可追溯原文；不得补写具体毒性、功效或剂量。
...
**P8 结论：** 暂保持 `no_source_found` 追溯状态与学习边界；异名线索需要后续人工 source_ref/alias 绑定复核，医学内容扩写仍需药典/权威现代中药学资料等外部来源。
