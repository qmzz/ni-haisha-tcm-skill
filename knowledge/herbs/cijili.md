...
只读 FTS 检索未找到“刺蒺藜”专名命中；另有“蒺藜/蒺藜子/白蒺藜”相关命中，属于通名或近缘语境，不能直接等同验证“刺蒺藜”条目。

本条目保持 `trace_status: no_source_found`。当前“来源：神农本草经”等字段未由本轮内部语料复核证实，仅作为待核验占位保留；后续需外部权威来源或明确的专名来源核验。
