...
当前倪海厦人纪系列资料范围内未找到「荜澄茄」的可追溯专门讲解。
...
- `data/herb_sources.jsonl` 对「荜澄茄」未检出来源命中。
- `data/herb_index.jsonl` / `p30` / `p36` 显示本条映射到 canonical `bichengqie`，但 canonical 仍为 no_source。
- `source_fts.sqlite` 只读检索「荜澄茄 / 毕澄茄」未见可用于支撑正文的命中。
