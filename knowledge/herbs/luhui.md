...
- 复核说明：当前未在倪海厦知识库中找到对该药材的专门讲解；P6-C 已标记为 `internal_research_exhausted`。

<!-- P5_STANDARD_NOTICE_END -->

## ⚠️ 高风险外部来源复核边界（P8 手工）

- **毒性/强作用概况：** 当前倪海厦语料、`herb_sources` 与 source FTS 均未检出可追溯命中；不得补写具体毒性、功效或剂量。
...
**P8 结论：** 保持 `no_source_found` 与 P6-C `internal_research_exhausted` 边界；本条目需要药典/权威现代中药学资料等外部来源后，才可进行医学内容扩写。
