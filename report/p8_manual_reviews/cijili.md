...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/cijili.md`
- **队列位置：** `data/review_queue.jsonl` 第 28 行
- **条目：** 刺蒺藜
...
- `review_queue`：第 28 行记录为 `no_source_found`。
...
- `source_fts.sqlite`：FTS 无「刺蒺藜」专名；仅见「蒺藜/蒺藜子/白蒺藜」通名或近缘语境。
