...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/luobumaye.md`
- **队列位置：** `data/review_queue.jsonl` 第 77 行
- **条目：** 罗布麻叶 (`luobumaye`)
...
- p30：`external_source_required`；canonical=`luobumaye`；risk=`low`。
- p36：当前分类=`herb_modern_or_regional`；建议来源范围以 p36 队列记录为准。
