...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/caodoukou.md`
- **队列位置：** `data/review_queue.jsonl` 第 22 行
- **条目：** 草豆蔻
...
- `review_queue`：第 22 行记录为 `no_source_found`。
...
- `source_fts.sqlite`：FTS 检索「草豆蔻/草蔻」无命中；p30/p36 外部来源 required。
