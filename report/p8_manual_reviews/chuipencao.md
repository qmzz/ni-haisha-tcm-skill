...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/chuipencao.md`
- **队列位置：** `data/review_queue.jsonl` 第 26 行
- **条目：** 垂盆草
...
- `review_queue`：第 26 行记录为 `no_source_found`。
...
- `source_fts.sqlite`：FTS 检索「垂盆草」无命中；p36 标为 herb_modern_or_regional。
