...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/jixueteng.md`
- **队列位置：** `data/review_queue.jsonl` 第 66 行
- **条目：** 鸡血藤 (`jixueteng`)
...
- p36：`external_source_required`；分类=`herb_modern_or_regional`；建议来源范围=`official_pharmacopoeia`、`modern_tcm_reference`、`classical_tcm_text`。
