...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/chouwutong.md`
- **队列位置：** `data/review_queue.jsonl` 第 24 行
- **条目：** 臭梧桐
...
- `review_queue`：第 24 行记录为 `no_source_found`。
...
- `source_fts.sqlite`：FTS 检索「臭梧桐」无命中；p36 标为 herb_modern_or_regional。
