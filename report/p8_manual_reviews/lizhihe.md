...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/lizhihe.md`
- **队列位置：** `data/review_queue.jsonl` 第 72 行
- **条目：** 荔枝核 (`lizhihe`)
...
- p30：`internal_research_exhausted`；canonical=`None`；risk=`low`。
- p36：当前分类=`herb_internal_exhausted`；建议来源范围以 p36 队列记录为准。
- P6-C 已标记内部语料复查耗尽；后续进入人工/外部权威来源策略，不在本轮扩写。
