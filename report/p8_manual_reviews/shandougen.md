...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/shandougen.md`
- **风险分类：** `herb_high_risk`
...
3. `data/source_fts.sqlite`
   - 以“山豆根 / 广豆根”检索 `source_pages_fts`，无命中
