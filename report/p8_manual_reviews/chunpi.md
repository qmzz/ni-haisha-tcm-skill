...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/chunpi.md`
- **队列位置：** `data/review_queue.jsonl` 第 27 行
- **条目：** 椿皮
...
- `review_queue`：第 27 行记录为 `no_source_found`。
...
- `source_fts.sqlite`：FTS 检索「椿皮」无命中；p30/p36 为 internal_research_exhausted。
