...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/cangerzi.md`
- **队列位置：** `data/review_queue.jsonl` 第 20 行
- **条目：** 苍耳子
...
- `review_queue`：第 20 行记录为 `no_source_found`。
...
- `source_fts.sqlite`：FTS 检索「苍耳子」无命中；p30/p36 外部来源 required。
