...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/caoguo.md`
- **队列位置：** `data/review_queue.jsonl` 第 23 行
- **条目：** 草果
...
- `review_queue`：第 23 行记录为 `no_source_found`。
...
- `source_fts.sqlite`：FTS 检索「草果」无命中；p30/p36 外部来源 required。
