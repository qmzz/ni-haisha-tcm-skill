...
- **复核时间：** 2026-07-06
- **当前文件：** `knowledge/herbs/cansha.md`
- **队列位置：** `data/review_queue.jsonl` 第 21 行
- **条目：** 蚕砂
...
- `review_queue`：第 21 行记录为 `no_source_found`。
...
- `source_fts.sqlite`：FTS 检索「蚕砂」无命中；p30/p36 外部来源 required。
