...
ITEMS = [
    "zisu", "zicao", "zhusha", "zhuling", "zhizi",
    "zhebeimu", "zaojiaoci", "zaojia", "yuyuliang", "yujin",
    "yuanzhi", "yiyiren", "yitang", "yinyanghuo", "yimucao",
    "yangqishi", "xuduan", "xuanshen", "xuanfuhua", "xionghuang",
    "xinyi", "xiaoji", "xiangru", "xiakucao", "wuyi",
    "wuyaozi", "wujiapi", "wugong", "tujuzi", "tianma",
]
