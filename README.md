# 倪海厦中医经方智能体体系 (Ni Haisha TCM Skill v3.1)
...
本项目是基于倪海厦先生《人纪》（《针灸大成》《神农本草经》《伤寒论》《金匮要略》《黄帝内经》《天纪》）及《汉唐中医方剂讲解》全景语料，深度提纯重构的中医经方智能体与全景知识库。
...
知识库全量子库收录 **1,166 篇** 高密度纯正 Markdown 文献，涵盖七大核心子库：

| 子库模块 | 路径 | 收录体量 | 结构规范与核心内容 |
| :--- | :--- | :---: | :--- |
| **经典经方库** | `knowledge/formulas/` | **113 首** | 经方原典 ➔ 倪师方义水火推演 ➔ 六经辨证抓手 ➔ 讲义医案实录 |
| **汉唐方剂库** | `knowledge/ht_formulas/` | **89 首** | 汉唐原方配伍 ➔ 倪师水火病机心法 ➔ 临床主治眼目 ➔ 讲义实录医案 |
...
# 指定分类过滤 (formulas / ht_formulas / herbs / acupoints / concepts / diagnosis / cases)
...
- **模式一：经方 / 汉唐方 / 本草 / 腧穴 / 概念咨询**：直调知识库原典，输出标准四大板块；
- **模式二：临床十问与辨证求治**：
